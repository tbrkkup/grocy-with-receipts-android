...
public class Equipment implements Parcelable {
  ...
  public static QueueItem getEquipment(
      ...
      public void perform(
        ...
        dlHelper.get(
            ...
            response -> {
              ...
              ArrayList<Equipment> equipmentList = dlHelper.gson.fromJson(response, type);
              if (dlHelper.debug) {
                Log.i(dlHelper.tag, "download Equipment: " + equipmentList);
              }
              if (onResponseListener != null) {
                onResponseListener.onResponse(equipmentList);
              }
              ...
              response -> {
                ...
                Single.fromCallable(() -> {
                  dlHelper.appDatabase.equipmentDao()
                      .deleteEquipment().blockingSubscribe();
                  dlHelper.appDatabase.equipmentDao()
                      .insertEquipment(equipmentList).blockingSubscribe();
